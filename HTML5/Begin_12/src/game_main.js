...
;(function ( $, window, document, undefined ) {
   ...
   $.extend(Game.prototype, {
         ...
         randomFruitFall:function(){
          var randomX = defaults.fruitSize;
          var ref = this;

          this.createBlock(75+randomX, defaults.foodTypes[1]);
          setTimeout(function(){
            ref.createBlock(75+randomX*2, defaults.foodTypes[1]);
          }, 400);

         },
         createBlock: function(xPos, itemType){
