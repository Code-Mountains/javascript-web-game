   ...
   $.extend(Game.prototype, {
         ...
         physicsWorld:function(){
            ...
            listener.BeginContact = function(contact){
                ref.ui.randomSwirlsAndDrips( (contact.GetFixtureA().GetBody().GetPosition().x*(defaults.SCALE*defaults.dpr)),
                  (contact.GetFixtureA().GetBody().GetPosition().y*(defaults.SCALE*defaults.dpr)) )
         ...
         animate: function(){
          ...
          this.world.ClearForces();
           ...
           for(var i=0;i<n;i++){
            ...
            actor.position.x = (body.GetPosition().x*defaults.SCALE)*defaults.dpr;
            actor.position.y = (body.GetPosition().y*defaults.SCALE)*defaults.dpr;
           }
